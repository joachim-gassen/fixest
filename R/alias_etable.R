...
#' @describeIn etable Exports the results of multiple `fixest` estimations in a Latex table.
esttable = function(..., 
                    vcov = NULL, 
                    stage = 2, 
                    agg = NULL, 
  ...
  etable(..., 
         ...
         interaction.combine = interaction.combine, 
         ...
         fixef.group = fixef.group, 
         drop.section = drop.section, 
         poly_dict = poly_dict, 
         postprocess.df = postprocess.df, 
...
esttex = function(..., 
  ...
  etable(..., 
         ...
         drop.section = drop.section, 
         poly_dict = poly_dict, 
         postprocess.tex = postprocess.tex, 
         tpt = tpt, 
